...
<body <?php body_class(); ?>>
  ...
  <button class="theme-toggle" id="themeToggle" type="button">
    ...
    <svg id="icon-sun" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M19.7778 4.22266L17.5558 6.25424" stroke="#000000" stroke-width="1.5" stroke-linecap="round" />
      <path d="M4.22217 4.22266L6.44418 6.25424" stroke="#000000" stroke-width="1.5" stroke-linecap="round" />
      <path d="M6.44434 17.5557L4.22211 19.7779" stroke="#000000" stroke-width="1.5" stroke-linecap="round" />
      <path d="M19.7778 19.7773L17.5558 17.5551" stroke="#000000" stroke-width="1.5" stroke-linecap="round" />
    </svg>

    <!-- Luna -->
    <svg id="icon-moon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  <div class="container">
    ...
    <div class="ascii-line">== <?php bloginfo('name'); ?> ==</div>
    <div class="ascii-line">=============================</div>
